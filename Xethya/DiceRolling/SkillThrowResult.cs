...
namespace Xethya.DiceRolling
{
    ...
    public class SkillThrowResult : ChanceThrowResult
    {
        ...
        /// </summary>
        public int SkillAttributeModifiersValue { get; set; }
        ...
        public SkillThrowResult(int skillValue, int skillAttributeModifiersValue, DiceThrowResult throwResult) : base(throwResult)
        {
